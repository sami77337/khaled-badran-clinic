...
# TEMPORARY WhatsApp outage mode; false/unset restores OTP-secured flows.
PATIENT_OTP_TEMPORARY_MODE = env_bool("PATIENT_OTP_TEMPORARY_MODE", False)
...
WHATSAPP_META_OTP_TEMPLATE_AR = os.getenv("WHATSAPP_META_OTP_TEMPLATE_AR", "")
WHATSAPP_META_OTP_TEMPLATE_EN = os.getenv("WHATSAPP_META_OTP_TEMPLATE_EN", "")
...
OTP_META_SENDER = "apps.whatsapp.meta.send_guest_otp" if WHATSAPP_META_ENABLED else ""
GUEST_CONSULTATION_OTP_SENDER = os.getenv(
    "GUEST_CONSULTATION_OTP_SENDER", OTP_META_SENDER,
)
PATIENT_ACCOUNT_OTP_SENDER = os.getenv(
    "PATIENT_ACCOUNT_OTP_SENDER", OTP_META_SENDER,
)
ACCOUNT_PHONE_CHANGE_OTP_SENDER = os.getenv(
    "ACCOUNT_PHONE_CHANGE_OTP_SENDER", OTP_META_SENDER,
)
APPOINTMENT_LINK_RECOVERY_OTP_SENDER = os.getenv(
